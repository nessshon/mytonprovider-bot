...
provider_menu = Window(
    I18NJinja("message.provider.menu"),
...
language_menu = Window(
    I18NJinja("message.language.menu"),
    keyboards.language_menu,
    state=states.LanguageMenu.MAIN,
)

help_menu = Window(
    I18NJinja("message.help.menu"),
    keyboards.help_menu,
